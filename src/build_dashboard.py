...
<div class="app">
  ...
  <div class="controls">
    ...
    <div class="control-group">
      ...
      <div id="refPeriodTabs" class="view-toggle"></div>
    </div>
    <div class="control-group">
...
function renderTopControls() {
  makePills(document.getElementById('refPeriodTabs'),
    PERIOD_LIST.map(p => ({ key: p.key, label: p.label })),
    state.refPeriod, (k) => { state.refPeriod = k; renderAll(); });
